...
<div class="container container-body">
	...
	<div class="row">
		...
		<div class="span6 menu-buttons">
			...
			<?php if($_SESSION['usertype'] == 1){?>
				<p>
				  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/system_calibration.php'">System Calibration</button>
				</p>
					...
					<div id="radio_collapse" class="collapse" style="margin-bottom:10px">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/add_radio.php'">Add radio</button>
				  		<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/radios.php'">View radios</button>
				  	</div>	
			<?php } ?>
			<p>
			  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/overview.php'">Overview</button>
			</p>
			<p>
			  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/alarms_events.php'">Alarms & Events</button>
			</p>
			<?php if($_SESSION['usertype'] == 1){?>
				<p>
				  <button class="btn btn-L btn-primary" type="button" data-toggle="collapse" data-target="#user_collapse">User accounts<b class="caret caret-body"></b></button>
					<div id="user_collapse" class="collapse">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/create_user.php'">Create user</button>
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/LAB_SERVER/users.php'">View users</button>
				  	</div>
				</p>
			<?php } ?>
			</br>
...
<?php 
require_once($_SERVER['DOCUMENT_ROOT'].'/LAB_SERVER/'.'footer.php');
